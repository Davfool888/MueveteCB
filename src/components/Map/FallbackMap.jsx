    ...
    <div className="fallback-map" id="fallback-map" aria-hidden="true">
      <svg viewBox="0 0 900 560" preserveAspectRatio="xMidYMid slice">
        ...
        <path
          ...
          fill="none"
          stroke={pathStroke}
          strokeWidth={isRoadRoute || !isVeredal ? 12 : 7}
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeDasharray={!isRoadRoute && isVeredal ? '10 9' : undefined}
